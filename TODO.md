...
| ID | Task | Source |
|----|------|--------|
| `PASTOR-BUNDLE-MASTER-PLAN` | Translate master engineering/product plan into phased delivery milestones | docs/TODO.md |
| `PASTOR-BUNDLE-PRD` | Deliver PRD-defined product outcomes for Pastor Abraham platform | docs/TODO.md |
| `VISUAL-VERIFY` | Visual verification via Playwright screenshots for 4 redesigned pages | HANDOVER.md |
